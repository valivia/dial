...
static void mqtt_event_handler(void *handler_args, esp_event_base_t base, int32_t event_id, void *event_data)
{
    ...
    case MQTT_EVENT_CONNECTED:
        ...
        msg_id = esp_mqtt_client_publish(client, "/phone/info", "Connected", 0, 1, 0);
        break;
...
void mqtt_task(void *args)
{
    ...
    ESP_LOGI(TAG, "Connecting to broker... (%s)", CONFIG_ESP_MQTT_URL);
...
{
    ESP_LOGI(TAG, "Publishing to %s: %s", topic, data);
    if (client)
    {
